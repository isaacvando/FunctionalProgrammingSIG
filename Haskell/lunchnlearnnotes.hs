...
-- data User = Admin String Int

type Point = (Double,Double)
data Shape = Circle Point Double | Square Point Point

getArea :: Shape -> Double
getArea (Circle _ radius) = 3.14159265 * radius * radius
getArea (Square (a,b) (c,d)) = abs (a - c) * abs (b - d)
...
-- type and value constructors are themselves functions
-- tagged union
